...
blockBlockhash.prototype.report = function (compilationResults) {
  return this.warningNodes.map(function (item, i) {
    return {
      warning: yo`<span>use of "block.blockhash": "block.blockhash" is used to access the last 256 block hashes. 
                ...
                This is especially easy if there are only a small number of equally likely outcomes.</span>`,
      location: item.src
    }
  })
}
