      ...
      markup: (
        ...
        >
          <button
            ...
            style={{pointerEvents: 'none', backgroundColor: 'inherit', color: 'white'}}
          >
  ...
  return (
    <div className="buttons">
      ...
      <div id="reverted" style={{display: revertedReason === '' ? 'none' : 'block'}}>
        ...
        <span className="text-warning" id="parenthasthrown" style={{display: revertedReason === 'parenthasthrown' ? 'inline' : 'none'}}>
