...
export declare type AnalysisReport = {
    name: string;
...
export declare type VisitFunction = (node: any) => void;
export declare type ReportFunction = (compilationResult: CompilationResult) => ReportObj[];
