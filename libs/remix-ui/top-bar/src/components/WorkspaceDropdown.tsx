import { CustomToggle, CustomTopbarMenu } from '@remix-ui/helper'
import React, { useEffect, useMemo, useRef, useState } from 'react'
import { Dropdown, Overlay } from 'react-bootstrap'
import { WorkspaceDropdownSubMenu } from './WorkspaceDropdownSubMenu'
...
export function WorkspaceDropdown ({ toggleDropdown, showDropdown, selectedWorkspace, currentWorkspace, NO_WORKSPACE, switchWorkspace, ShowNonLocalHostMenuItems, CustomToggle, global, showSubMenuFlyOut, setShowSubMenuFlyOut }: WorkspaceDropdownProps) {

  const [subMenuFlyOutIndex, setSubMenuFlyOutIndex] = useState<number | null>(null)
    ...
    >
      ...
      {showSubMenuFlyOut ? (
        <WorkspaceDropdownSubMenu
          menuItems={items}
          style={{ borderRadius: '8px', position: 'absolute', left: `${62.5}dvw`,
            right: `${28}dvw`,
            bottom: `${50}dvh`,
            top: `${10}dvh`,
...
export const NestedDropdown: React.FC<NestedDropdownProps> = ({ items, toggleDropdown, showDropdown, selectedWorkspace, currentWorkspace, NO_WORKSPACE, switchWorkspace, ShowNonLocalHostMenuItems, CustomToggle, global }) => {
