      ...
      <div className="$border-top">
        ...
        <div className="card-body pt-3 pb-2">
          ...
          <div className="mt-2 custom-control custom-checkbox mb-1">
            ...
            <label className={`form-check-label vertical-align custom-control-label align-middle ${getTextClass('settings/text-wrap')}`} htmlFor="editorWrap">
          ...
          <div className="custom-control custom-checkbox mb-1">
            ...
            <label
              className={`form-check-label vertical-align custom-control-label align-middle ${getTextClass('settings/auto-completion')}`}
          ...
          <div className="custom-control custom-checkbox mb-1">
            ...
            <label
              className={`form-check-label vertical-align custom-control-label align-middle ${getTextClass('settings/show-gas')}`}
          ...
          <div className="custom-control custom-checkbox mb-1">
            ...
            <label
              className={`form-check-label vertical-align custom-control-label align-middle ${getTextClass('settings/display-errors')}`}
          ...
          <div className="custom-control custom-checkbox mb-1">
            ...
            <label className={`form-check-label vertical-align custom-control-label align-middle ${getTextClass('settings/personal-mode')}`} htmlFor="personal">
          ...
          <div className="custom-control custom-checkbox mb-1">
            ...
            <label data-id="label-matomo-settings" className={`form-check-label vertical-align custom-control-label align-middle ${getTextClass('settings/matomo-analytics')}`} htmlFor="settingsMatomoAnalytics">
              <span>
          ...
          <div className="custom-control custom-checkbox mb-1">
            ...
            <label
              className={`form-check-label vertical-align custom-control-label align-middle ${getTextClass('settings/save-evm-state')}`}
      ...
      <div className="card-body pt-3 pb-2">
        ...
        <div className="pt-2 mb-0">
          <div className="text-secondary mb-0 h6">
            <div>
              <div className="mb-1">
                <label className={`form-check-label vertical-align align-middle ${getTextClass('settings/copilot/suggest/max_new_tokens')}`} htmlFor="copilot-activate">
        ...
        <div className="pt-2 mb-0">
          <div className="text-secondary mb-0 h6">
            <div>
              <div className="mb-1">
                <label className={`form-check-label vertical-align align-middle ${getTextClass('settings/copilot/suggest/temperature')}`} htmlFor="copilot-activate">
