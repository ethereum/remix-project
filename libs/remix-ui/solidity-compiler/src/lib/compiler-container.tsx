    ...
    <section>
      <article>
        <header className='remixui_compilerSection border-bottom'>
          ...
          <button id="compileBtn" data-id="compilerContainerCompileBtn" className="btn btn-primary remixui_btnBlock remixui_disabled mt-3" title="Compile" onClick={compile} disabled={disableCompileButton}>
            <span>
