        ...
        <div className="pt-0 remixui_compilerSection">
          <div className="mb-1">
            ...
            <CustomTooltip
              ...
              tooltipText={
                <FormattedMessage id="solidity.addACustomCompilerWithURL" />
              }
            >
              <span
              ...
              >
                <div id="compilerLanguageSelectorWrapper">
                  <select
                    ...
                    style={{
                      pointerEvents: state.useFileConfiguration
                        ? 'none'
                        : 'auto'
                    }}
                  >
            ...
            <CustomTooltip
              ...
              tooltipText={
                <div className="text-left">
                  {!(configFilePath === '' && state.useFileConfiguration) && (
                    <div>
                      <b>Ctrl+S</b> to compile{' '}
                      {state.compiledFileName.endsWith('.sol')
