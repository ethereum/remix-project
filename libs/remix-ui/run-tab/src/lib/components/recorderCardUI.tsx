...
export function RecorderUI(props: RecorderProps) {
  ...
  return (
    <div className="udapp_cardContainer py-1 list-group-item border-top border-bottom">
      ...
      >
        <div className="d-flex justify-content-center align-items-center">
          ...
          <CustomTooltip
            ...
            tooltipText={
              <FormattedMessage id="udapp.transactionsCountTooltip" />
            }
          >
            <div
              className="ml-2 badge badge-pill badge-primary text-center"
      ...
      <div
        className={`pb-2 flex-column ${toggleExpander ? 'd-flex' : 'd-none'}`}
      >
        <div className="mb-1 mt-1 custom-control custom-checkbox mb-1">
          ...
          <CustomTooltip
            ...
            tooltipText={
              <span>
                <FormattedMessage
                  id="udapp.livemodeRecorderTooltip"
                  values={{br: <br />}}
                />
              </span>
            }
          ...
          <CustomTooltip
            ...
            tooltipText={
              props.count === 0
                ...
                : props.count === 1
                  ? intl.formatMessage(
                    {id: 'udapp.transactionSaveTooltip2'},
                    {count: props.count}
                  )
                  : intl.formatMessage(
                    {id: 'udapp.transactionSaveTooltip3'},
                    {count: props.count}
                  )
            }
          >
