        ...
        describe('assert library GREATERTHAN method tests', function () {
            ...
            it('should return', () => {
                deepEqualExcluding(tests, [
                    ...
                    { type: 'testPass', debugTxHash: '0xcf394fd279293cdcf58efc42f3a443595fdb171769a45df01b0c84cd76b3a9a2', value: 'Greater than int uint pass test', filename: __dirname + '/examples_0/assert_greaterThan_test.sol', context: 'AssertGreaterThanTest' },
