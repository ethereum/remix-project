...
module.exports = {
  ...
  'Disable auto compile': function (browser: NightwatchBrowser) {
    browser.waitForElementVisible('[for="autoCompile"]').click('[for="autoCompile"]') // we set it too false in the local storage
  },
  'Should load the code from URL params (code param) #group1': function (browser: NightwatchBrowser) {
    browser

      .url(
        'http://127.0.0.1:8080/#autoCompile=true&optimize=true&runs=300&code='
      )
      ...
      .getEditorValue((content) => {
        browser.assert.ok(
          content && content.indexOf('https://github.com/OpenZeppelin/openzeppelin-contracts/blob/master/contracts/access/Ownable.sol') !== -1,
  ...
  'Should load the code from URL params (url param) #group1': function (browser: NightwatchBrowser) {
    browser
      ...
      .currentWorkspaceIs('code-sample')
      .getEditorValue((content) => {
        browser.assert.ok(content && content.indexOf('proposals.length = _numProposals;') !== -1, 'url has not been loaded')
      })
  },
  ...
  'Should load Etherscan verified contracts from URL "address" param)': !function (browser: NightwatchBrowser) {
    browser
      ...
      .getEditorValue((content) => {
        browser.assert.ok(content && content.indexOf('contract Sample {') !== -1)
      })
      ...
      .getEditorValue((content) => {
        browser.assert.ok(content && content.indexOf('contract TetherToken is Pausable, StandardToken, BlackList {') !== -1)
      })
  },
  ...
  'Should load the code from URL & code params #group1': function (browser: NightwatchBrowser) {
    browser
      ...
      .currentWorkspaceIs('code-sample')
      .getEditorValue((content) => {
        browser.assert.ok(content && content.indexOf('proposals.length = _numProposals;') !== -1, 'code has been loaded')
      })
  },
  ...
  'Should load the code from language & code params #group1': function (browser: NightwatchBrowser) {
    browser
      ...
      .url(
        'http://127.0.0.1:8080/#language=yul&code=&optimize=false&runs=200&evmVersion=null'
      )
      .refreshPage()
      .waitForElementVisible('[data-id="compilerContainerCompileBtn"]')
      ...
      .getEditorValue((content) => {
        browser.assert.ok(content && content.indexOf('object "Contract1" {') !== -1)
      })
  },
  ...
  'Should load json files from link passed in remix URL #group3': function (browser: NightwatchBrowser) {
    browser
      .url(
        'http://127.0.0.1:8080/#optimize=false&runs=200&url=https://raw.githubusercontent.com/EthVM/evm-source-verification/main/contracts/1/0x011e5846975c6463a8c6337eecf3cbf64e328884/input.json'
      )
      .refreshPage()
