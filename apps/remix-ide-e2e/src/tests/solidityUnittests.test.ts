...
module.exports = {
  ...
  'Solidity Unit tests with hardhat console log #group4': function (browser: NightwatchBrowser) {
    ...
    browser
      ...
      .waitForElementContainsText('#journal > div:nth-child(3) > span', 'Before all:')
      .waitForElementContainsText('#journal > div:nth-child(3) > span', 'Inside beforeAll')
      .waitForElementContainsText('#journal > div:nth-child(4) > span', 'Check sender:')
      .waitForElementContainsText('#journal > div:nth-child(4) > span', 'msg.sender is 0x5B38Da6a701c568545dCfcB03FcB875f56beddC4')
      .waitForElementContainsText('#journal > div:nth-child(5) > span', 'Check int logs:')
      .waitForElementContainsText('#journal > div:nth-child(5) > span', '10 20')
      .waitForElementContainsText('#journal > div:nth-child(5) > span', 'Number is 25')
