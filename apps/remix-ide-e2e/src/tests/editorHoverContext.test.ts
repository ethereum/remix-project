...
const checkEditorHoverContent = (browser: NightwatchBrowser, path: string, expectedContent: string, offsetLeft: number = 0) => {
  browser
    ...
    .useCss()
    .waitForElementContainsText('.monaco-hover-content', expectedContent)
    .pause(1000)
}
...
module.exports = {
  ...
  'Should show hover over function in editor #group1': function (browser: NightwatchBrowser) {
    ...
    const path: string =
      "//*[@class='view-line' and contains(.,'giveRightToVote(address') and contains(.,'function') and contains(.,'public')]//span//span[contains(.,'giveRightToVote')]"
