...
yarn add -D chromedriver@$135 geckodriver --cwd  "$directory" ||  yarn add -D chromedriver@$135 geckodriver --cwd  "$directory" || yarn add -D chromedriver geckodriver --cwd  "$directory" || exit 1
