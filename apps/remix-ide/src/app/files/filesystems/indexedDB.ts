...
export class IndexedDBStorage extends LightningFS {
  ...
  extended: {
    ...
    readdir: (path: any) => Promise<string[]>
    unlink: (path: any) => Promise<void>
    mkdir: (path: any) => Promise<void>
    readFile: (path: any, options: any) => Promise<Uint8Array>
    rename: (from: any, to: any) => Promise<void>
    writeFile: (path: any, content: any, options: any) => Promise<void>
    stat: (path: any) => Promise<import('fs').Stats>
    init(name: string, opt?: LightningFS.FSConstructorOptions): void
    activate(): Promise<void>
    deactivate(): Promise<void>
    lstat(filePath: string): Promise<import('fs').Stats>
